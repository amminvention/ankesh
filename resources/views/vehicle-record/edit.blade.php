    ...
    <div class="content-wrapper">
        <div class="row grid-margin">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Edit Vehicle Record</h4>
                        <form class="cmxform" method="POST" action="{{ route('vehicle-record.update', $vehicle_record->id) }}">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                            <fieldset>
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('vehicle_no') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="vehicle_no" class="form-control{{ $errors->has('vehicle_no') ? ' form-control-danger' : '' }}" name="vehicle_no" value="{{ $vehicle_record->vehicle_no }}" type="text">
                                        ...
                                        <div class="form-group{{ $errors->has('customer_id') ? ' has-danger' : '' }}">
                                            ...
                                            <select id="customer_id" name="customer_id" class="js-example-basic-single w-100">
                                                @foreach($customers as $id => $name)
                                                    <option value="{{ $id }}" {{ $vehicle_record->customer_id == $id ? 'selected' : '' }}>{{ $id.") " . " " . $name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('device_model') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="device_model" class="form-control{{ $errors->has('device_model') ? ' form-control-danger' : '' }}" name="device_model" value="{{ $vehicle_record->device_model }}" type="text">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('device_imei') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="device_imei" class="form-control{{ $errors->has('device_imei') ? ' form-control-danger' : '' }}" name="device_imei" value="{{ $vehicle_record->device_imei }}" type="text">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('sim_no') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="sim_no" class="form-control{{ $errors->has('sim_no') ? ' form-control-danger' : '' }}" name="sim_no" value="{{ $vehicle_record->sim_no }}" type="text">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('last_pay_date') ? ' has-danger' : '' }}">
                                            ...
                                            <div class="input-group date datepicker datepicker-popup">
                                                <input id="last_pay_date" class="form-control{{ $errors->has('last_pay_date') ? ' form-control-danger' : '' }}" name="last_pay_date" value="{{ $vehicle_record->last_pay_date }}" type="text" readonly>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('last_pay_amount') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="last_pay_amount" class="form-control{{ $errors->has('last_pay_amount') ? ' form-control-danger' : '' }}" name="last_pay_amount" value="{{ $vehicle_record->last_pay_amount }}" type="text">
                                        ...
                                        <div class="form-group{{ $errors->has('sale_type_id') ? ' has-danger' : '' }}">
                                            ...
                                            <select id="sale_type_id" name="sale_type_id" class="js-example-basic-single w-100">
                                                @foreach($sale_types as $id => $name)
                                                    <option value="{{ $id }}" {{ $vehicle_record->sale_type_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('date_of_install') ? ' has-danger' : '' }}">
                                            ...
                                            <div class="input-group date datepicker datepicker-popup">
                                                <input readonly id="date_of_install" class="form-control{{ $errors->has('date_of_install') ? ' form-control-danger' : '' }}" name="date_of_install" value="{{ $vehicle_record->date_of_install }}" type="text">
                                                <span class="input-group-addon input-group-append border-left">
                                                  <span class="mdi mdi-calendar input-group-text"></span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('renewal_date') ? ' has-danger' : '' }}">
                                            ...
                                            <div class="input-group date datepicker datepicker-popup">
                                                <input readonly id="renewal_date" class="form-control{{ $errors->has('renewal_date') ? ' form-control-danger' : '' }}" name="renewal_date" value="{{ $vehicle_record->renewal_date }}" type="text">
                                                <span class="input-group-addon input-group-append border-left">
                                                  <span class="mdi mdi-calendar input-group-text"></span>
                                                </span>
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('renewal_amount') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="renewal_amount" class="form-control{{ $errors->has('renewal_amount') ? ' form-control-danger' : '' }}" name="renewal_amount" value="{{ $vehicle_record->renewal_amount }}" type="text">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('duration') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="duration" class="form-control{{ $errors->has('duration') ? ' form-control-danger' : '' }}" name="duration" value="{{ $vehicle_record->duration }}" type="text">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('agreed_rate') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="agreed_rate" class="form-control{{ $errors->has('agreed_rate') ? ' form-control-danger' : '' }}" name="agreed_rate" value="{{ $vehicle_record->agreed_rate }}" type="text">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group{{ $errors->has('sales_person') ? ' has-danger' : '' }}">
                                            ...
                                            <input id="tags" class="form-control{{ $errors->has('sales_person') ? ' form-control-danger' : '' }}" name="sales_person" type="text" value="{{ $vehicle_record->sales_person }}" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group{{ $errors->has('remarks') ? ' has-danger' : '' }}">
                                            ...
                                            <textarea rows="6" id="remarks" class="form-control{{ $errors->has('remarks') ? ' form-control-danger' : '' }}" name="remarks" type="text">{{ $vehicle_record->remarks }}</textarea>
